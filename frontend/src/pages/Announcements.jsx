...
const Announcements = () => {
  ...
  {/* Toast Notification */}
  {toastMsg && (
    <div className="fixed bottom-6 right-6 z-[200] flex items-center gap-2 px-4 py-3 rounded-xl bg-[#1e2640] text-white shadow-xl border border-slate-700/50 text-sm font-medium transition-all animate-in fade-in slide-in-from-bottom-4">
  ...
  <div className="max-w-6xl mx-auto space-y-6">
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200 dark:border-slate-800">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold tracking-tight flex items-center gap-2.5 text-[#1e2640] dark:text-slate-100">
          <span className="p-2.5 bg-[#1e2640]/5 dark:bg-[#1e2640]/40 text-[#1e2640] dark:text-[#dc9750] rounded-xl border border-[#1e2640]/10 dark:border-[#dc9750]/20">
            <Megaphone size={22} />
          </span>
          Announcements
        </h1>
      ...
      {isAdmin && (
        <button
          ...
          className="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-[#dc9750] hover:bg-[#b97737] text-white text-sm font-medium rounded-xl shadow-sm hover:shadow transition-all active:scale-[0.98]"
        >
    ...
    <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
      ...
      <div className="relative flex-1 max-w-md">
        ...
        <input
          ...
          className="w-full pl-10 pr-9 py-2 text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#1e2640]/20 focus:border-[#1e2640] dark:focus:border-[#dc9750] text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 shadow-xs transition-all"
        />
        {searchQuery && (
          <button
        ...
        <button
          ...
          className={`px-3 py-1.5 rounded-lg text-xs font-medium whitespace-nowrap transition-colors ${
            selectedCategory === 'All'
              ? 'bg-[#1e2640] text-white dark:bg-slate-100 dark:text-[#1e2640]'
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs font-medium whitespace-nowrap transition-colors ${
              selectedCategory === cat
                ? 'bg-[#1e2640] text-[#dc9750] dark:bg-[#1e2640] dark:text-[#dc9750]'
                : 'bg-white dark:bg-slate-900 text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800'
            }`}
          >
            {cat}
    ...
    {loading ? (
      <div className="flex flex-col justify-center items-center py-20 gap-3">
        <Loader2 size={32} className="animate-spin text-[#1e2640] dark:text-[#dc9750]" />
      ...
      <div className="flex flex-col items-center justify-center py-16 px-4 bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-2xl text-center shadow-xs">
        <div className="p-3 bg-[#1e2640]/5 dark:bg-slate-800/60 rounded-full text-[#1e2640] dark:text-[#dc9750] mb-3">
          <Megaphone size={32} />
        </div>
        ...
        {(searchQuery || selectedCategory !== 'All') && (
          <button
            ...
            className="mt-4 px-3 py-1.5 text-xs font-medium text-[#1e2640] dark:text-[#dc9750] hover:bg-[#1e2640]/5 dark:hover:bg-[#1e2640]/30 rounded-lg transition-colors"
          >
            Clear Filters
          </button>
        )}
      ...
      <div className="space-y-4">
        {filteredAnnouncements.map((a) => (
          <div
            ...
            className={`group bg-white dark:bg-slate-900 border rounded-2xl p-5 sm:p-6 shadow-xs hover:shadow-md transition-all relative ${
              a.pinned
                ? 'border-[#dc9750]/60 dark:border-[#dc9750]/40 ring-1 ring-[#dc9750]/20'
          ...
          >
            ...
            <div className="flex items-start justify-between gap-4 mb-3">
              <div className="flex flex-col gap-2 flex-1">
                <div className="flex items-center gap-2 flex-wrap">
                  {a.pinned && (
                    <span className="inline-flex items-center gap-1 text-[11px] font-semibold text-[#1e2640] dark:text-[#dc9750] bg-[#1e2640]/5 dark:bg-[#1e2640]/40 px-2.5 py-0.5 rounded-md border border-[#1e2640]/15 dark:border-[#dc9750]/30">
              ...
              {isAdmin && (
                <div className="flex items-center gap-1 opacity-90 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity bg-slate-50 dark:bg-slate-800/80 p-1 rounded-lg border border-slate-200/60 dark:border-slate-700/60 flex-shrink-0">
                  <button
                    onClick={() => togglePin(a)}
                    className="p-1.5 text-slate-500 hover:text-[#1e2640] dark:text-slate-400 dark:hover:text-[#dc9750] rounded-md hover:bg-white dark:hover:bg-slate-700 transition-colors"
                  ...
                  <button
                    ...
                    className="p-1.5 text-slate-500 hover:text-[#dc9750] dark:text-slate-400 dark:hover:text-[#dc9750] rounded-md hover:bg-white dark:hover:bg-slate-700 transition-colors"
                    title="Archive"
                  >
                    <Archive size={15} />
                  </button>
              ...
              <div className="flex flex-wrap gap-2 mb-4 p-2.5 bg-slate-50 dark:bg-slate-800/40 rounded-xl border border-slate-100 dark:border-slate-800">
                {a.attachments.map((att, i) => (
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-xs text-slate-700 dark:text-slate-300 hover:border-[#1e2640] hover:text-[#1e2640] dark:hover:border-[#dc9750] dark:hover:text-[#dc9750] transition-colors shadow-2xs"
                  >
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 pt-3.5 border-t border-slate-100 dark:border-slate-800/80 text-xs">
              <div className="flex items-center gap-1.5 text-slate-400 dark:text-slate-500 font-medium">
                <Calendar size={13} />
                <span>Posted by <strong className="text-slate-700 dark:text-slate-300 font-semibold">{a.postedBy?.name || 'Unknown'}</strong></span>
                <span>&middot;</span>
              ...
              <div className="flex items-center gap-3">
                {canViewReadStatus && (
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-2.5 py-1 text-xs font-medium text-slate-600 dark:text-slate-400 hover:text-[#1e2640] dark:hover:text-[#dc9750] hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors"
                  >
                ...
                {hasAcknowledged(a) ? (
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg text-xs font-semibold text-[#1e2640] dark:text-[#dc9750] hover:bg-[#1e2640]/5 dark:hover:bg-[#1e2640]/40 border border-[#1e2640]/20 dark:border-[#dc9750]/30 transition-colors"
                  >
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 text-sm bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl outline-none focus:border-[#1e2640] focus:ring-2 focus:ring-[#1e2640]/20 text-slate-900 dark:text-slate-100 transition-all"
          ...
          <div className="flex items-center gap-2 pt-1">
            <input
              ...
              className="rounded border-slate-300 text-[#1e2640] focus:ring-[#1e2640] h-4 w-4"
            />
          ...
          <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex justify-end gap-3">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="inline-flex items-center gap-2 px-4 py-2 text-xs font-semibold bg-[#1e2640] hover:bg-[#161c30] disabled:opacity-50 text-white rounded-xl shadow-xs transition-all"
            >
              {submitting && <Loader2 size={14} className="animate-spin text-[#dc9750]" />}
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl max-w-md w-full p-6 shadow-2xl max-h-[80vh] overflow-y-auto">
        ...
        {!readStatusData ? (
          <div className="flex justify-center py-10">
            <Loader2 size={24} className="animate-spin text-[#1e2640] dark:text-[#dc9750]" />
          </div>
        ) : (
