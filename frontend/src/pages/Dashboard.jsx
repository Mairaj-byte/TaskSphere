        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5 relative z-10">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 px-4 py-2.5 text-xs sm:text-sm font-semibold text-white transition-all shadow-lg shadow-indigo-600/20 active:scale-95"
            >
              <Plus size={16} />
              Create Task
            </button>
